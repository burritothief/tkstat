...
{"type":"assistant","message":{"model":"claude-sonnet-4-5-20250929","usage":{"input_tokens":0,"cache_creation_input_tokens":200,"cache_creation":{"ephemeral_5m_input_tokens":100,"ephemeral_1h_input_tokens":100},"cache_read_input_tokens":0,"output_tokens":0}},"requestId":"smoke-claude-sonnet-cache-ttl","uuid":"smoke-claude-sonnet-cache-ttl-uuid","timestamp":"2026-01-31T21:37:42.435Z","sessionId":"smoke-claude-session"}
